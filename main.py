...
from commands.test_command import test_command # Import from the 'commands' folder

my_bot_token = '6837488267:AAErZxNef6olksbz2hdLpJE4mDvLGKhoofQ'
...
def main() -> None:
  ...
  # Add the command handler for /test
